...
def main():
    ...
    extract_email_body_and_attachments(args.path_to_eml_file, args.output_directory, args.suffix)
...
#     extract_email_body_to_txt(args.path_to_eml_file, args.output_directory, args.suffix)
